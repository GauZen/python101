...
.. plot::
    ...
    >>> plt.plot(x, y, label='analytical')  # doctest: +ELLIPSIS
    [<matplotlib.lines.Line2D object at ...>]
    >>> plt.legend(loc='lower right')  # doctest: +ELLIPSIS
...
.. plot::
    ...
    >>> plt.plot(x, y_with_errors, label='sample')  # doctest: +ELLIPSIS
    [<matplotlib.lines.Line2D object at ...>]
    >>> plt.legend(loc='lower right')  # doctest: +ELLIPSIS
    <matplotlib.legend.Legend object at ...>
    >>> plt.show()
...
.. plot::
    ...
    >>> plt.plot(x, y_fit, label='fit')  # doctest: +ELLIPSIS
    [<matplotlib.lines.Line2D object at ...>]
    >>> plt.legend(loc='lower right')  # doctest: +ELLIPSIS
    <matplotlib.legend.Legend object at ...>
    >>> plt.show()

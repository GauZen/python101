...
# -*- coding: utf-8 -*-
#
# Python 101 documentation build configuration file.
#
...
try:
    release = pkg_resources.get_distribution('python101').version
except pkg_resources.DistributionNotFound:
    print(
        'Python 101 must be installed to build the documentation.\nInstall '
        'from source using `pip install -e .` in a virtualenv.',
        file=sys.stderr)
    sys.exit(1)
